    ...
    function get_value_submission( $field_values, $get_from_post=true ) {
     ...
     function get_field_input( $form, $value = '', $entry = null ) {
        ...
        $atts['stepvalue'] = $this->stepvalue;       
            ...
            if (!empty($value)) {
                $valueee = $value['input_'.$id];
            }else{
                $valueee = '';
            }
            
            $ocgr = "<div class='ginput_container'><div class='".$class_name."'   sliderposition='".$atts['slider_position']."'  step='".$atts['stepvalue']."'  prefix='".$atts['Prefixvalue']."'   slidershow='".$atts['slider_show']."' rangeshow='".$atts['range_show']."'  min='".$atts['min']."'  max='".$atts['max']."' label='".$atts['slider_label']."' ><input  name='input_".$id."'  id='". $form_id."' value='".$valueee."' type='".$atts['type']."' value='".$_POST["input_".$id]."' /></div></div>";
 ...
 {      
        ...
        if ($position == 50) {
            ...
            <li class="slider_position field_setting">
                ...
                <input type="radio"  class="gf_rs_radio" name="slider_position" value="left"  checked="checked" onchange="SetFieldProperty('slider_position', this.value);" disabled=""/>
                ...
                <label class="ocgfrs_pro_link">Only available in pro version <a href="https://oceanwebguru.com/shop/range-slider-for-gravity-forms-pro/" target="_blank">link</a></label>
            </li>
            ...
            <li class="slider_show field_setting">
                ...
                <input type="radio"  class="gf_rs_radio"  name="sliderdisplay" checked="checked" value="single_slider"   onchange="SetFieldProperty('slider_show', this.value);" disabled=""/>
