  	...
  	class OCRSGF {
        ...
        function OCRSGF_plugin_row_meta( $links, $file ) {
            if ( OCRSGF_BASE_NAME === $file ) {
                $row_meta = array(
                  'rating'    =>  ' <a href="https://oceanwebguru.com/how-to-setup-range-slider-for-gravity-form/" target="_blank">Documentation</a> | <a href="https://oceanwebguru.com/contact-us/" target="_blank">Support</a> | <a href="https://wordpress.org/support/plugin/range-slider-for-gravity-form/reviews/?filter=5" target="_blank"><img src="'.OCRSGF_PLUGIN_DIR.'/includes/image/star.png" class="ocrsgf_rating_div"></a>',
                );
        ...
        function enqueue_custom_script() {
            ...
            wp_enqueue_script( 'OCGFRS-jquery-ui-js', OCRSGF_PLUGIN_DIR .'/includes/js/jquery-ui.js', false, '2.0.0' ,true);
            wp_enqueue_script( 'OCGFRS-jquery-ui-touch-punch-js', OCRSGF_PLUGIN_DIR .'/includes/js/jquery.ui.touch-punch.min.js', false, '2.0.0',true );
            ...
            wp_enqueue_script( 'OCGFRS-jquery-ui-slider-pips-js', OCRSGF_PLUGIN_DIR .'/includes/js/jquery-ui-slider-pips.js', false, '2.0.0',true );
            wp_enqueue_script( 'custom_script', OCRSGF_PLUGIN_DIR.'/includes/js/front.js',array('jquery'),'',true);
        }
          //Plugin Rating
